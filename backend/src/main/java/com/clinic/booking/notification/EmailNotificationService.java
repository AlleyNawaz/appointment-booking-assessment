...
public class EmailNotificationService {
    ...
    public EmailNotificationService(JavaMailSender mailSender, ProviderRepository providerRepository, AppointmentTypeRepository appointmentTypeRepository) {
    ...
    public void sendBookingNotification(Appointment appointment) {
        try {
            log.info("Sending {} notification HTML email to {} (and BCC to {}) for appointment {}",
    ...
    public void sendCancelNotification(Appointment appointment) {
        try {
            log.info("Sending CANCELLED notification HTML email to {} (and BCC to {}) for appointment {}",
                    appointment.getPatientEmail(), ADMIN_EMAIL, appointment.getConfirmationToken());
    ...
    public void sendRescheduleNotification(Appointment appointment, String oldConfirmationToken) {
        try {
            log.info("Sending RESCHEDULED notification HTML email to {} (and BCC to {}) for appointment {}",
                    appointment.getPatientEmail(), ADMIN_EMAIL, appointment.getConfirmationToken());
